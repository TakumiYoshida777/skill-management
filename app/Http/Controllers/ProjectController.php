        ...
        try {
            ...
            $project = Project::query()
                ->create([
                    ...
                    "unit_testing_flag" =>  $request->unit_testing_flag == "on" ? 1 : 0,
                    "integration_testing_flag" =>  $request->integration_testing_flag  == "on" ? 1 : 0,
                    "system_testing_flag" =>  $request->system_testing_flag == "on" ? 1 : 0,
                    "operation_testing_flag" =>  $request->operation_testing_flag == "on" ? 1 : 0,
